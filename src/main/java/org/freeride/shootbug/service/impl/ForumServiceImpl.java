...
import org.freeride.shootbug.util.IdUtil;
...
public class ForumServiceImpl implements ForumService {
    ...
    @Override
    public PageInfo<PostReplyResponse> getPostReplies(Integer pageNum, Integer pageSize, String postId) {
    ...
    public void replyPost(ReplyPostRequest replyPostRequest) {
        ...
        replyMapper.insertReply(IdUtil.generateUUID(), userId, postId, content, LocalDateTime.now());
    }

    @Override
    public void deleteReply(DeleteReplyRequest deleteReplyRequest) {
        String replyId = deleteReplyRequest.getReplyId();

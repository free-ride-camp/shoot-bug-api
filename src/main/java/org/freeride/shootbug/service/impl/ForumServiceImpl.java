...
public class ForumServiceImpl implements ForumService {
    ...
    @Override
    public PageInfo<Post> getPosts(Integer pageNum, Integer pageSize, List<String> tags, String searchText) throws JsonProcessingException {
        ...
        return page.doSelectPageInfo(() -> postMapper.findPosts(tagsJsonArray, searchText));
    }
